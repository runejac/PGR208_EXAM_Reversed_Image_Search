...
import com.example.eksamen_pgr208.activities.SavedActivity
...
class SavedAdapter(val context: Context?, private var imageDatabaseModels: List<ImageDatabaseModel>, private val listener: SavedActivity): RecyclerView.Adapter<RecyclerView.ViewHolder>()   {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        Glide.with(context!!.applicationContext).load(imageDatabaseModels[position].image)
            .fitCenter()
    ...
    override fun getItemCount(): Int {
        return imageDatabaseModels.size
    }
